...
echo "$($PSQL "SELECT name FROM teams FULL JOIN games ON teams.team_id=games.winner_id AND teams.team_id=games.opponent_id WHERE name LIKE 'Co%' ORDER BY name")"
